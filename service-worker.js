const CACHE_NAME = "spani-rh-betesda-v12";
const ASSETS = ["./","./index.html","./style.css?v=12","./script.js?v=12","./manifest.json?v=12","./assets/logo.svg"];
...
self.addEventListener("fetch",event=>{
  ...
  if(core){event.respondWith(fetch(request,{cache:"no-store"}).catch(()=>caches.match("./index.html")));return;}
